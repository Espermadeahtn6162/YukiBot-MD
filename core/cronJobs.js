...
export function iniciarAutomatizaciones(sock) {
  // ⚠️ REEMPLAZA ESTO CON EL ID REAL DEL GRUPO DE LOS INSANOS (ejemplo: '120363012345678901@g.us')
  ...
  const enviarAlGrupoInsano = async (mensaje) => {
    try {
      if (GRUPO_INSANOS_ID.includes('AQUI_VA_EL_ID')) {
  ...
  console.log('✅ Automatizaciones exclusivas para el Grupo Insano activadas.');
}
