...
export default {
  ...
  run: async ({ msg, sock, args, usedPrefix, command }) => {
    ...
    const basePrompt = `Tu nombre es ${botname} y parece haber sido creada por Daxer. Tu versión actual es 1.5, Tú usas el idioma Español. Llamarás a las personas por su nombre ${username}, te gusta ser divertida, y te encanta aprender. Lo más importante es que debes ser amigable con la persona con la que estás hablando. ${username}`;
    try {
